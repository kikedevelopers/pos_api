...
describe('RegisterPurchasePaymentAction', () => {
  ...
  beforeEach(async () => {
    ...
    const getCashRegisterBalanceMock = {
      execute: jest.fn().mockResolvedValue({ balance: 0, updatedAt: '' }),
    };
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: GetCashRegisterBalanceAction, useValue: getCashRegisterBalanceMock },
      ],
    }).compile();
