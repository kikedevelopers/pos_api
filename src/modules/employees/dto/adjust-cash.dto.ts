...
/**
 * Body de `POST /employees/:id/cash-register/adjust`. Operación administrativa
 * del `owner` para fijar el balance que DEBE tener la caja del empleado.
 */
export class AdjustCashDto {
  ...
  /**
   * Razón del ajuste — opcional, se incluye en la descripción del log y
   * del FinancialMovement. Si se omite, se usa "Ajuste administrativo".
   */
